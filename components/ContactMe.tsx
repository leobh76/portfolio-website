  ...
  return (
    <div className="h-screen flex flex-col relative text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
      ...
      <div className="flex flex-col space-y-10">
        ...
        <p className="text-center text-sm font-light text-gray-400">This website was built by me using:<br></br><span className="text-gray-300">Next.js, Tailwind CSS, Sanity CMS & more</span></p>
      </div>
    </div>
  );
}
